# N-Chat PowerShell Management Script
# سكريپت PowerShell لإدارة N-Chat
param(
    [string]$Command = ""
)
...
function Show-SystemStatus {
    ...
    if (Test-Path "package.json") {
        ...
        Write-Host "⚛️  Next.js: $($packageJson.dependencies.next)" -ForegroundColor $Blue
        Write-Host "⚛️  React: $($packageJson.dependencies.react)" -ForegroundColor $Blue
    }
