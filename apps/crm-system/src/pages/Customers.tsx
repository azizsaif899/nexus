...
import { Search, Filter, Plus, MoreVertical, Phone, Mail, Calendar, Loader2 } from 'lucide-react';
...
export default function Customers() {
  ...
  const { customers, loading, fetchCustomers, error } = useCRM();
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">إدارة وتتبع جميع عملائك من خلال API</p>
        </div>
