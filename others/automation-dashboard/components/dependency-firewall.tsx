...
import { handleSuggestDependencyFirewallRules } from '@/automation-dashboard/actions';
import { SuggestDependencyFirewallRulesOutput } from '@/automation-dashboard/ai/suggest-dependency-firewall-rules';
