...
exports.AdvancedChatbot = void 0;
const tslib_1 = require("tslib");
const common_1 = require("@nestjs/common");
let AdvancedChatbot = class AdvancedChatbot {
    constructor() {
    ...
    async generateResponse(message, analysis, history, profile) {
    ...
    classifyIntent(message) {
        ...
        if (greetings.some(word => lowerMessage.includes(word)))
            return 'greeting';
        if (questions.some(word => lowerMessage.includes(word)))
            return 'question';
        if (requests.some(word => lowerMessage.includes(word)))
            return 'request';
        if (complaints.some(word => lowerMessage.includes(word)))
            return 'complaint';
        return 'general';
    }
    ...
    generateSuggestions(analysis, profile) {
        return [
...
exports.AdvancedChatbot = AdvancedChatbot = tslib_1.__decorate([
    (0, common_1.Injectable)()
], AdvancedChatbot);
//# sourceMappingURL=advanced-chatbot.js.map