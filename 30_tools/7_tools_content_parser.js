// *************************************************************************************************
// --- START OF FILE: 30_tools/7_tools_content_parser.js ---
// *************************************************************************************************
...
defineModule('System.Tools.ContentParser', ({ Utils, DocsManager }) => {
   ...
   */
  function combineSourceFiles(files) {
  ...
  return { combineSourceFiles, extractCodeBlocks, removeCodeBlocks };
});

// *************************************************************************************************
// --- END OF FILE: 30_tools/7_tools_content_parser.js ---
// *************************************************************************************************