// *************************************************************************************************
// --- START OF FILE: 35_accounting/ChartOfAccounts.js ---
// *************************************************************************************************
...
defineModule('System.Accounting.ChartOfAccounts', ({ Utils, Config, DocsManager }) => {
  ...
  return { getAccounts, addAccount, validateAccount };
});

// *************************************************************************************************
// --- END OF FILE: 35_accounting/ChartOfAccounts.js ---
// *************************************************************************************************