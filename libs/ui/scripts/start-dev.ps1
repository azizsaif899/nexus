...
# Configuration
$PORT = 5173
$PROJECT_DIR = "C:\nexus\apps\CRM"  # Update this path
...
function Navigate-ToProject {
    Print-Step "Step 2: Navigating to project directory..."
    
    if (Test-Path $PROJECT_DIR) {
        Set-Location $PROJECT_DIR
        Print-Success "Current directory: $PROJECT_DIR"
    }
    else {
        Print-Error "Project directory not found: $PROJECT_DIR"
        Print-Info "Please update the PROJECT_DIR variable in this script"
...
function Start-DevServer {
    ...
    Print-Info "Starting Vite dev server on port $PORT..."
