...
/**
 * دالة onOpen هي دالة خاصة في Google Apps Script يتم تشغيلها
 * تلقائيًا عند فتح المستند (مثل Google Sheet أو Doc) الذي يحتوي على السكريبت.
 * تقوم بإعداد المؤقتات للوكلاء الأذكياء.
 * @param {GoogleAppsScript.Events.SheetsOnOpen|GoogleAppsScript.Events.DocsOnOpen|GoogleAppsScript.Events.FormsOnOpen|GoogleAppsScript.Events.SlidesOnOpen} e حدث الفتح.
 */
function onOpen(e) {
  // يجب التأكد من تهيئة System.AgentTriggers قبل استدعاء هذه الدالة
  if (typeof System !== 'undefined' && System.AgentTriggers && typeof System.AgentTriggers.setupAgentTriggers === 'function') {
    ...
    Logger.log('Error: System.AgentTriggers.setupAgentTriggers is not defined or callable on open.');
  }
}
