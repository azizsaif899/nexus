...
import { CFOAgent } from '../../packages/sidebar-agents/src/cfo-agent';
import { DeveloperAgent } from '../../packages/sidebar-agents/src/developer-agent';
import { DatabaseManager } from '../../packages/sidebar-agents/src/database-manager';
import { OperationsAgent } from '../../packages/sidebar-agents/src/operations-agent';
import { GeneralAgent } from '../../packages/sidebar-agents/src/general-agent';
...
describe('🤖 Sidebar Agents Tests', () => {
  ...
  describe('Developer Agent', () => {
    ...
    it('should review code quality', async () => {
      ...
      expect(review.score).toBeGreaterThan(7);
  ...
  describe('General Agent', () => {
    ...
    it('should provide contextual help', async () => {
      ...
      expect(help.suggestions).toHaveLength.greaterThan(0);
