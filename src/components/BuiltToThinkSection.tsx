            ...
            <div className="mt-8 space-y-4">
              <div className="rounded-lg bg-accent/50 p-4">
                  <div className="flex justify-between mb-1">
                      <span className="text-base font-medium text-primary">AI-Powered Automation</span>
              ...
              <div className="rounded-lg bg-accent/50 p-4">
                  <div className="flex justify-between mb-1">
                      <span className="text-base font-medium text-primary">Customer Satisfaction</span>
