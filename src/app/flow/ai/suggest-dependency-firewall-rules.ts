...
export type SuggestDependencyFirewallRulesInput = z.infer<typeof SuggestDependencyFirewallRulesInputSchema>;

const SuggestDependencyFirewallRulesOutputSchema = z.object({
  recommendations: z.string().describe('Recommendations for stricter dependency declarations.'),
  unexpectedDependencies: z.string().describe('Any unexpected implicit shared dependency.'),
});
export type SuggestDependencyFirewallRulesOutput = z.infer<typeof SuggestDependencyFirewallRulesOutputSchema>;

export async function suggestDependencyFirewallRules(input: SuggestDependencyFirewallRulesInput): Promise<SuggestDependencyFirewallRulesOutput> {
